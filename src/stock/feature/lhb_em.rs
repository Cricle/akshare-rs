...
impl AkShareClient {
    ...
    pub async fn stock_lhb_stock_statistic_em(
        ...
        Ok(data.iter().map(|v| LhbStockStatistic {
            code: json_str(v, "SECURITY_CODE"),
            name: json_str(v, "SECURITY_NAME_ABBR"),
    ...
    pub async fn stock_lhb_jgstatistic_em(
        ...
        Ok(data.iter().map(|v| LhbJgstatistic {
            code: json_str(v, "SECURITY_CODE"),
            name: json_str(v, "SECURITY_NAME_ABBR"),
            close_price: json_f64(v, "CLOSE_PRICE"),
            change_pct: json_f64(v, "CHANGE_RATE"),
    ...
    /// 营业部排行
    pub async fn stock_lhb_yybph_em(
        &self,
        symbol: &str,
    ) -> Result<Vec<LhbYybph>> {
        let cycle = match symbol {
    ...
    pub async fn stock_lhb_traderstatistic_em(
        ...
        Ok(data.iter().map(|v| LhbTraderStatistic {
    ...
    pub async fn stock_lhb_stock_detail_date_em(
        ...
        Ok(data.iter().map(|v| LhbStockDetailDate {
            trade_date: json_str(v, "TRADE_DATE"),
            close_price: json_f64(v, "CLOSE_PRICE"),
            change_pct: json_f64(v, "CHANGE_RATE"),
            reason: json_str(v, "EXPLANATION"),
    ...
    pub async fn stock_lhb_stock_detail_em(
        ...
        let filter = format!("(TRADE_DATE='{}')(SECURITY_CODE=\"{symbol}\")", fmt_date(date));
        let data = self.dc_fetch_all(
            report,
            "ALL",
            &filter,
        ...
        Ok(data.iter().map(|v| LhbStockDetail {
            trade_date: json_str(v, "TRADE_DATE"),
            code: json_str(v, "SECURITY_CODE"),
            name: json_str(v, "SECURITY_NAME_ABBR"),
            close_price: json_f64(v, "CLOSE_PRICE"),
    ...
    pub async fn stock_lhb_yyb_detail_em(
        ...
        Ok(data.iter().map(|v| LhbYybDetail {
            trade_date: json_str(v, "TRADE_DATE"),
            code: json_str(v, "SECURITY_CODE"),
            name: json_str(v, "SECURITY_NAME_ABBR"),
            close_price: json_f64(v, "CLOSE_PRICE"),
