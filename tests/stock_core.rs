...
fn sample_tx_tick_body() -> String {
    r#"v_sz000001=["1|09:30:00|10.50|0.15|10000|1050000|B","1|09:31:00|10.51|0.16|8000|840080|S"];"#.to_string()
}
...
async fn test_a_share_trade_calendar_sse() {
    ...
    let client = mock_client(&server);
    let _ = client.a_share_trade_calendar("SSE", "20240101", "20240131").await;
}
...
async fn test_a_share_trade_calendar_szse() {
    ...
    mock_any_post(&server, ".*", sample_trade_calendar_body()).await;
    let client = mock_client(&server);
    let _ = client.a_share_trade_calendar("SZSE", "20240101", "20240131").await;
}
...
async fn test_stock_zh_a_daily_qfq() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_daily("600000", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_a_daily_hfq() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_daily("600000", "20240101", "20241231", "hfq").await;
}
...
async fn test_stock_zh_a_daily_raw() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_daily("600000", "20240101", "20241231", "").await;
}
...
async fn test_stock_zh_a_daily_sz() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_daily("sz000001", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_a_stop_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_a_stop_em().await;
}
...
async fn test_stock_zh_a_cdr_daily() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_cdr_daily("688001", "20240101", "20241231").await;
}
...
async fn test_stock_zh_a_hist_pre_min_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_a_hist_pre_min_em("600000", "09:00", "09:30").await;
}
...
async fn test_stock_zh_a_hist_tx_raw() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_a_hist_tx("sz000001", "20240101", "20241231", "").await;
}
...
async fn test_stock_zh_a_hist_tx_qfq() {
    ...
    mock_any_get(&server, ".*", sample_tx_a_hist_body("sz000001")).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_hist_tx("sz000001", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_a_hist_tx_hfq() {
    ...
    mock_any_get(&server, ".*", sample_tx_a_hist_body("sz000001")).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_hist_tx("sz000001", "20240101", "20241231", "hfq").await;
}
...
async fn test_stock_zh_a_hist_tx_sh() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_a_hist_tx("sh600000", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_b_daily_qfq() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_b_daily("sh900901", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_b_daily_hfq() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_b_daily("sh900901", "20240101", "20241231", "hfq").await;
}
...
async fn test_stock_zh_b_daily_raw() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_b_daily("sh900901", "20240101", "20241231", "").await;
}
...
async fn test_stock_zh_b_daily_short_code() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_b_daily("900901", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_ah_daily_qfq() {
    ...
    mock_any_get(&server, ".*", sample_tencent_kline_body("02318")).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_ah_daily("02318", "2024", "2024", "qfq").await;
}
...
async fn test_stock_zh_ah_daily_hfq() {
    ...
    mock_any_get(&server, ".*", sample_tencent_kline_body("02318")).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_ah_daily("02318", "2024", "2024", "hfq").await;
}
...
async fn test_stock_zh_index_daily_em_sh() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_index_daily_em("000001", "20240101", "20241231").await;
}
...
async fn test_stock_zh_index_daily_em_sz() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_index_daily_em("399001", "20240101", "20241231").await;
}
...
async fn test_stock_zh_index_daily_tx() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_index_daily_tx("sh000001", "20240101", "20241231").await;
}
...
async fn test_stock_zh_index_daily_tx_no_prefix() {
    ...
    mock_any_get(&server, ".*", sample_tx_index_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_index_daily_tx("000001", "20240101", "20241231").await;
}
...
async fn test_stock_zh_kcb_daily_qfq() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_kcb_daily("688399", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_kcb_daily_hfq() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_kcb_daily("688399", "20240101", "20241231", "hfq").await;
}
...
async fn test_stock_zh_kcb_daily_raw() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_kcb_daily("688399", "20240101", "20241231", "").await;
}
...
async fn test_stock_zh_kcb_daily_with_prefix() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_kcb_daily("sh688399", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_kcb_report_em_single_page() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_kcb_report_em(1, 1).await;
}
...
async fn test_stock_zh_kcb_report_em_multi_page() {
    ...
    mock_any_get(&server, ".*", sample_kcb_report_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_kcb_report_em(1, 3).await;
}
...
async fn test_stock_intraday_sina_limit_100() {
    ...
    mock_any_get(&server, ".*", sample_sina_tick_list()).await;
    let client = mock_client(&server);
    let _ = client.stock_intraday_sina("sz000001", "20240321", 100).await;
}
...
async fn test_stock_hk_daily_qfq() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_daily("00593", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_hk_daily_hfq() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_daily("00593", "20240101", "20241231", "hfq").await;
}
...
async fn test_stock_hk_daily_raw() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_daily("00593", "20240101", "20241231", "").await;
}
...
async fn test_stock_hk_famous_spot_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_hk_famous_spot_em().await;
}
...
async fn test_stock_hk_hot_rank_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_hk_hot_rank_em().await;
}
...
async fn test_stock_hk_hot_rank_latest_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_hk_hot_rank_latest_em("00593").await;
}
...
async fn test_stock_hk_hot_rank_detail_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_hk_hot_rank_detail_em("00593").await;
}
...
async fn test_stock_hk_hot_rank_detail_realtime_em() {
    ...
    mock_any_post(&server, ".*", sample_hot_rank_detail_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_hot_rank_detail_realtime_em("00593").await;
}
...
async fn test_stock_hk_valuation_baidu() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_hk_valuation_baidu("00593", "\u{5e02}\u{76c8}\u{7387}(TTM)", "\u{8fd1}\u{4e00}\u{5e74}").await;
}
...
async fn test_stock_hk_valuation_baidu_mv() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_valuation_baidu("00593", "\u{603b}\u{5e02}\u{503c}", "\u{8fd1}\u{4e09}\u{5e74}").await;
}
...
async fn test_stock_hk_scale_comparison_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_hk_scale_comparison_em("00593").await;
}
...
async fn test_stock_hk_dividend_payout_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_hk_dividend_payout_em("00593").await;
}
...
async fn test_stock_hk_fhpx_detail_ths() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_hk_fhpx_detail_ths("00593").await;
}
...
async fn test_stock_hk_financial_indicator_em() {
    ...
    mock_any_get(&server, ".*", sample_em_dc_list_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_financial_indicator_em("00593").await;
}
...
async fn test_stock_us_daily_with_prefix() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_daily("105.AAPL", "20240101", "20241231").await;
}
...
async fn test_stock_us_famous_spot_em_tech() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_us_famous_spot_em("\u{79d1}\u{6280}\u{7c7b}").await;
}
...
async fn test_stock_us_famous_spot_em_finance() {
    ...
    mock_any_get(&server, ".*", sample_us_famous_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_famous_spot_em("\u{91d1}\u{878d}\u{7c7b}").await;
}
...
async fn test_stock_us_famous_spot_em_pharma() {
    ...
    mock_any_get(&server, ".*", sample_us_famous_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_famous_spot_em("\u{533b}\u{836f}\u{98df}\u{54c1}\u{7c7b}").await;
}
...
async fn test_stock_us_famous_spot_em_media() {
    ...
    mock_any_get(&server, ".*", sample_us_famous_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_famous_spot_em("\u{5a92}\u{4f53}\u{7c7b}").await;
}
...
async fn test_stock_us_famous_spot_em_auto() {
    ...
    mock_any_get(&server, ".*", sample_us_famous_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_famous_spot_em("\u{6c7d}\u{8f66}\u{80fd}\u{6e90}\u{7c7b}").await;
}
...
async fn test_stock_us_famous_spot_em_retail() {
    ...
    mock_any_get(&server, ".*", sample_us_famous_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_famous_spot_em("\u{5236}\u{9020}\u{96f6}\u{552e}\u{7c7b}").await;
}
...
async fn test_stock_us_pink_spot_em() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_us_pink_spot_em().await;
}
...
async fn test_stock_us_valuation_baidu_mv() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_valuation_baidu("NVDA", "\u{603b}\u{5e02}\u{503c}", "\u{8fd1}\u{4e00}\u{5e74}").await;
}
...
async fn test_stock_us_valuation_baidu_pe() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_valuation_baidu("AAPL", "\u{5e02}\u{76c8}\u{7387}(TTM)", "\u{8fd1}\u{4e09}\u{5e74}").await;
}
...
async fn test_stock_us_valuation_baidu_pb() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_valuation_baidu("MSFT", "\u{5e02}\u{51c0}\u{7387}", "\u{5168}\u{90e8}").await;
}
...
async fn test_stock_zh_dupont_comparison_em_sz() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_dupont_comparison_em("SZ000895").await;
}
...
async fn test_stock_zh_dupont_comparison_em_sh() {
    ...
    mock_any_get(&server, ".*", sample_dupont_dc_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_dupont_comparison_em("SH600000").await;
}
...
async fn test_stock_zh_scale_comparison_em_sz() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_scale_comparison_em("SZ000895").await;
}
...
async fn test_stock_zh_scale_comparison_em_sh() {
    ...
    mock_any_get(&server, ".*", sample_scale_dc_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_scale_comparison_em("SH600000").await;
}
...
async fn test_stock_zh_valuation_baidu_mv() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_valuation_baidu("002044", "\u{603b}\u{5e02}\u{503c}", "\u{8fd1}\u{4e00}\u{5e74}").await;
}
...
async fn test_stock_zh_valuation_baidu_pe() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_valuation_baidu("002044", "\u{5e02}\u{76c8}\u{7387}(TTM)", "\u{8fd1}\u{4e09}\u{5e74}").await;
}
...
async fn test_stock_zh_valuation_baidu_pb() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_valuation_baidu("000001", "\u{5e02}\u{51c0}\u{7387}", "\u{8fd1}\u{4e94}\u{5e74}").await;
}
...
async fn test_stock_zh_valuation_baidu_pcf() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_valuation_baidu("600000", "\u{5e02}\u{73b0}\u{7387}", "\u{5168}\u{90e8}").await;
}
...
async fn test_stock_zh_vote_baidu_stock() {
    ...
    let client = mock_client(&server);
    let _ = client.stock_zh_vote_baidu("000001", "\u{80a1}\u{7968}").await;
}
...
async fn test_stock_zh_vote_baidu_index() {
    ...
    mock_any_get(&server, ".*", sample_baidu_vote_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_vote_baidu("000001", "\u{6307}\u{6570}").await;
}
...
async fn test_stock_board_concept_cons_em() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_board_concept_cons_em("BK0001", 10).await;
}
...
async fn test_stock_board_industry_cons_em() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_board_industry_cons_em("BK0001", 10).await;
}
...
async fn test_stock_sh_a_spot_em() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_sh_a_spot_em().await;
}
...
async fn test_stock_sz_a_spot_em() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_sz_a_spot_em().await;
}
...
async fn test_stock_bj_a_spot_em() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_bj_a_spot_em().await;
}
...
async fn test_stock_cy_a_spot_em() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_cy_a_spot_em().await;
}
...
async fn test_stock_kc_a_spot_em() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_kc_a_spot_em().await;
}
...
async fn test_stock_zh_a_daily_short_date_range() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_daily("600000", "20240102", "20240103", "qfq").await;
}
...
async fn test_stock_zh_a_hist_pre_min_em_sz() {
    ...
    mock_any_get(&server, ".*", sample_trends2_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_hist_pre_min_em("000001", "09:15", "09:25").await;
}
...
async fn test_stock_zh_a_cdr_daily_sz() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_a_cdr_daily("000001", "20240601", "20240630").await;
}
...
async fn test_stock_zh_b_daily_200xxx() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_b_daily("200001", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_ah_daily_02318() {
    ...
    mock_any_get(&server, ".*", sample_tencent_kline_body("02318")).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_ah_daily("02318", "2023", "2024", "qfq").await;
}
...
async fn test_stock_zh_index_daily_em_399006() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_index_daily_em("399006", "20240101", "20241231").await;
}
...
async fn test_stock_zh_index_daily_tx_sz() {
    ...
    mock_any_get(&server, ".*", sample_tx_index_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_index_daily_tx("sz399001", "20240101", "20241231").await;
}
...
async fn test_stock_zh_kcb_daily_688001() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_kcb_daily("688001", "20240101", "20241231", "qfq").await;
}
...
async fn test_stock_zh_kcb_report_em_page2() {
    ...
    mock_any_get(&server, ".*", sample_kcb_report_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_kcb_report_em(2, 2).await;
}
...
async fn test_stock_intraday_sina_limit_120() {
    ...
    mock_any_get(&server, ".*", sample_sina_tick_list()).await;
    let client = mock_client(&server);
    let _ = client.stock_intraday_sina("sz000001", "20240321", 120).await;
}
...
async fn test_stock_hk_daily_long_range() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_daily("00593", "20200101", "20241231", "qfq").await;
}
...
async fn test_stock_hk_hot_rank_latest_em_09988() {
    ...
    mock_any_post(&server, ".*", sample_hot_rank_latest_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_hot_rank_latest_em("09988").await;
}
...
async fn test_stock_hk_hot_rank_detail_em_09988() {
    ...
    mock_any_post(&server, ".*", sample_hot_rank_detail_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_hot_rank_detail_em("09988").await;
}
...
async fn test_stock_hk_hot_rank_detail_realtime_em_09988() {
    ...
    mock_any_post(&server, ".*", sample_hot_rank_detail_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_hot_rank_detail_realtime_em("09988").await;
}
...
async fn test_stock_hk_valuation_baidu_pb() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_valuation_baidu("00593", "\u{5e02}\u{51c0}\u{7387}", "\u{5168}\u{90e8}").await;
}
...
async fn test_stock_hk_scale_comparison_em_09988() {
    ...
    mock_any_get(&server, ".*", sample_hk_scale_result_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_scale_comparison_em("09988").await;
}
...
async fn test_stock_hk_dividend_payout_em_09988() {
    ...
    mock_any_get(&server, ".*", sample_em_dc_list_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_dividend_payout_em("09988").await;
}
...
async fn test_stock_hk_fhpx_detail_ths_09988() {
    ...
    mock_any_get_text(&server, ".*", &sample_ths_fhpx_html()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_fhpx_detail_ths("09988").await;
}
...
async fn test_stock_hk_financial_indicator_em_09988() {
    ...
    mock_any_get(&server, ".*", sample_em_dc_list_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_hk_financial_indicator_em("09988").await;
}
...
async fn test_stock_us_valuation_baidu_pcf() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_us_valuation_baidu("GOOG", "\u{5e02}\u{73b0}\u{7387}", "\u{8fd1}\u{4e94}\u{5e74}").await;
}
...
async fn test_stock_zh_dupont_comparison_em_bj() {
    ...
    mock_any_get(&server, ".*", sample_dupont_dc_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_dupont_comparison_em("BJ430047").await;
}
...
async fn test_stock_zh_scale_comparison_em_bj() {
    ...
    mock_any_get(&server, ".*", sample_scale_dc_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_scale_comparison_em("BJ430047").await;
}
...
async fn test_stock_zh_valuation_baidu_all() {
    ...
    mock_any_get(&server, ".*", sample_baidu_valuation_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_zh_valuation_baidu("600000", "\u{603b}\u{5e02}\u{503c}", "\u{5168}\u{90e8}").await;
}
...
async fn test_stock_board_concept_cons_em_bk0475() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_board_concept_cons_em("BK0475", 20).await;
}
...
async fn test_stock_board_industry_cons_em_bk0475() {
    ...
    mock_any_get(&server, ".*", sample_clist_spot_body()).await;
    let client = mock_client(&server);
    let _ = client.stock_board_industry_cons_em("BK0475", 20).await;
}
...
async fn test_stock_hk_daily_invalid_adjust() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let result = client.stock_hk_daily("00593", "20240101", "20241231", "invalid").await;
    assert!(result.is_err());
}
...
async fn test_stock_zh_a_daily_invalid_adjust() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let result = client.stock_zh_a_daily("600000", "20240101", "20241231", "bad").await;
    assert!(result.is_err());
}
...
async fn test_stock_zh_b_daily_invalid_adjust() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let result = client.stock_zh_b_daily("sh900901", "20240101", "20241231", "bad").await;
    assert!(result.is_err());
}
...
async fn test_stock_zh_kcb_daily_invalid_adjust() {
    ...
    mock_any_get(&server, ".*", sample_kline_body()).await;
    let client = mock_client(&server);
    let result = client.stock_zh_kcb_daily("688399", "20240101", "20241231", "bad").await;
    assert!(result.is_err());
}
...
async fn test_stock_zh_a_hist_tx_invalid_adjust() {
    ...
    mock_any_get(&server, ".*", sample_tx_a_hist_body("sz000001")).await;
    let client = mock_client(&server);
    let result = client.stock_zh_a_hist_tx("sz000001", "20240101", "20241231", "bad").await;
    assert!(result.is_err());
}
...
async fn test_stock_zh_dupont_comparison_em_short_symbol() {
    ...
    mock_any_get(&server, ".*", sample_dupont_dc_body()).await;
    let client = mock_client(&server);
    let result = client.stock_zh_dupont_comparison_em("X").await;
    assert!(result.is_err());
}
...
async fn test_stock_zh_scale_comparison_em_short_symbol() {
    ...
    mock_any_get(&server, ".*", sample_scale_dc_body()).await;
    let client = mock_client(&server);
    let result = client.stock_zh_scale_comparison_em("X").await;
    assert!(result.is_err());
}
...
async fn test_stock_zh_vote_baidu_invalid_indicator() {
    ...
    mock_any_get(&server, ".*", sample_baidu_vote_body()).await;
    let client = mock_client(&server);
    let result = client.stock_zh_vote_baidu("000001", "invalid").await;
    assert!(result.is_err());
}
...
async fn test_stock_us_famous_spot_em_invalid_category() {
    ...
    mock_any_get(&server, ".*", sample_us_famous_body()).await;
    let client = mock_client(&server);
    let result = client.stock_us_famous_spot_em("\u{65e0}\u{6548}").await;
    assert!(result.is_err());
}
