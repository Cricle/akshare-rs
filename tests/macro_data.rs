...
async fn mount_em_mocks(server: &MockServer) {
    let body = common::em_datacenter_response(vec![
        common::sample_macro_row("2024-01-01", 123.45, "GDP"),
    ]);
...
macro_test!(test_macro_china_new_house_price, macro_china_new_house_price);
macro_test!(test_macro_china_enterprise_boom_index, macro_china_enterprise_boom_index);
macro_test!(test_macro_china_national_tax_receipts, macro_china_national_tax_receipts);
macro_test!(test_macro_china_new_financial_credit, macro_china_new_financial_credit);
macro_test!(test_macro_china_fx_gold, macro_china_fx_gold);
macro_test!(test_macro_china_stock_market_cap, macro_china_stock_market_cap);
macro_test!(test_macro_china_reserve_requirement_ratio, macro_china_reserve_requirement_ratio);
macro_test!(test_macro_china_consumer_goods_retail, macro_china_consumer_goods_retail);
...
macro_test!(test_china_enterprise_boom_index, china_enterprise_boom_index);
macro_test!(test_china_national_tax_receipts, china_national_tax_receipts);
...
macro_test!(test_china_fixed_asset_investment, china_fixed_asset_investment);
...
macro_test!(test_china_reserve_requirement_ratio, china_reserve_requirement_ratio);
macro_test!(test_china_consumer_goods_retail, china_consumer_goods_retail);
...
macro_test!(test_macro_china_insurance_income, macro_china_insurance_income);
macro_test!(test_macro_china_mobile_number, macro_china_mobile_number);
macro_test!(test_macro_china_vegetable_basket, macro_china_vegetable_basket);
macro_test!(test_macro_china_agricultural_product, macro_china_agricultural_product);
macro_test!(test_macro_china_agricultural_index, macro_china_agricultural_index);
macro_test!(test_macro_china_energy_index, macro_china_energy_index);
macro_test!(test_macro_china_commodity_price_index, macro_china_commodity_price_index);
macro_test!(test_macro_china_yw_electronic_index, macro_china_yw_electronic_index);
macro_test!(test_macro_china_construction_index, macro_china_construction_index);
macro_test!(test_macro_china_construction_price_index, macro_china_construction_price_index);
...
macro_test!(test_china_commodity_price_index, china_commodity_price_index);
...
macro_test!(test_china_construction_price_index, china_construction_price_index);
...
macro_test!(test_macro_china_industrial_production_yoy, macro_china_industrial_production_yoy);
...
macro_test!(test_macro_china_cx_services_pmi_yearly, macro_china_cx_services_pmi_yearly);
macro_test!(test_macro_china_non_man_pmi, macro_china_non_man_pmi);
macro_test!(test_macro_china_fx_reserves_yearly, macro_china_fx_reserves_yearly);
...
macro_test!(test_china_industrial_production_yoy, china_industrial_production_yoy);
...
macro_test!(test_macro_china_market_margin_sz, macro_china_market_margin_sz);
macro_test!(test_macro_china_market_margin_sh, macro_china_market_margin_sh);
...
macro_test!(test_macro_china_central_bank_balance, macro_china_central_bank_balance);
macro_test!(test_macro_china_insurance, macro_china_insurance);
macro_test!(test_macro_china_supply_of_money, macro_china_supply_of_money);
macro_test!(test_macro_china_foreign_exchange_gold, macro_china_foreign_exchange_gold);
macro_test!(test_macro_china_retail_price_index, macro_china_retail_price_index);
macro_test!(test_macro_china_society_electricity, macro_china_society_electricity);
macro_test!(test_macro_china_society_traffic_volume, macro_china_society_traffic_volume);
macro_test!(test_macro_china_postal_telecommunicational, macro_china_postal_telecommunicational);
macro_test!(test_macro_china_international_tourism_fx, macro_china_international_tourism_fx);
macro_test!(test_macro_china_passenger_load_factor, macro_china_passenger_load_factor);
...
macro_test!(test_macro_china_urban_unemployment, macro_china_urban_unemployment);
...
async fn test_macro_china_nbs_nation() {
    ...
    mount_em_mocks(&server).await;
    let client = common::mock_client(&server);
    let result = client.macro_china_nbs_nation("月度数据", "A010101", "202401").await;
    let _ = result;
}
...
async fn test_macro_china_nbs_region() {
    ...
    mount_em_mocks(&server).await;
    let client = common::mock_client(&server);
    let result = client.macro_china_nbs_region("分省月度数据", "A010101", "110000", "202401").await;
    let _ = result;
}
...
macro_test!(test_macro_usa_personal_spending, macro_usa_personal_spending);
...
macro_test!(test_macro_usa_unemployment_rate, macro_usa_unemployment_rate);
...
macro_test!(test_macro_usa_real_consumer_spending, macro_usa_real_consumer_spending);
...
macro_test!(test_macro_usa_industrial_production, macro_usa_industrial_production);
macro_test!(test_macro_usa_durable_goods_orders, macro_usa_durable_goods_orders);
...
macro_test!(test_macro_usa_business_inventories, macro_usa_business_inventories);
macro_test!(test_macro_usa_ism_non_pmi, macro_usa_ism_non_pmi);
macro_test!(test_macro_usa_nahb_house_market_index, macro_usa_nahb_house_market_index);
...
macro_test!(test_macro_usa_house_price_index, macro_usa_house_price_index);
macro_test!(test_macro_usa_spcs20, macro_usa_spcs20);
macro_test!(test_macro_usa_pending_home_sales, macro_usa_pending_home_sales);
macro_test!(test_macro_usa_cb_consumer_confidence, macro_usa_cb_consumer_confidence);
macro_test!(test_macro_usa_nfib_small_business, macro_usa_nfib_small_business);
macro_test!(test_macro_usa_michigan_consumer_sentiment, macro_usa_michigan_consumer_sentiment);
...
macro_test!(test_us_pending_home_sales_jin10, us_pending_home_sales_jin10);
...
macro_test!(test_us_michigan_consumer_sentiment, us_michigan_consumer_sentiment);
...
macro_test!(test_macro_usa_cme_merchant_goods_holding, macro_usa_cme_merchant_goods_holding);
...
macro_test!(test_macro_usa_cftc_merchant_currency_holding, macro_usa_cftc_merchant_currency_holding);
macro_test!(test_macro_usa_cftc_merchant_goods_holding, macro_usa_cftc_merchant_goods_holding);
...
macro_test!(test_us_cftc_merchant_currency_holding, us_cftc_merchant_currency_holding);
macro_test!(test_us_cftc_merchant_goods_holding, us_cftc_merchant_goods_holding);
...
macro_test!(test_macro_euro_retail_sales_mom, macro_euro_retail_sales_mom);
macro_test!(test_macro_euro_employment_change_qoq, macro_euro_employment_change_qoq);
macro_test!(test_macro_euro_unemployment_rate_mom, macro_euro_unemployment_rate_mom);
macro_test!(test_macro_euro_trade_balance, macro_euro_trade_balance);
macro_test!(test_macro_euro_current_account_mom, macro_euro_current_account_mom);
macro_test!(test_macro_euro_industrial_production_mom, macro_euro_industrial_production_mom);
macro_test!(test_macro_euro_manufacturing_pmi, macro_euro_manufacturing_pmi);
macro_test!(test_macro_euro_services_pmi, macro_euro_services_pmi);
macro_test!(test_macro_euro_zew_economic_sentiment, macro_euro_zew_economic_sentiment);
macro_test!(test_macro_euro_sentix_investor_confidence, macro_euro_sentix_investor_confidence);
...
macro_test!(test_euro_industrial_production_mom, euro_industrial_production_mom);
macro_test!(test_euro_manufacturing_pmi, euro_manufacturing_pmi);
macro_test!(test_euro_services_pmi, euro_services_pmi);
macro_test!(test_euro_zew_economic_sentiment, euro_zew_economic_sentiment);
macro_test!(test_euro_sentix_investor_confidence, euro_sentix_investor_confidence);
...
macro_test!(test_macro_japan_core_cpi_yearly, macro_japan_core_cpi_yearly);
macro_test!(test_macro_japan_unemployment_rate, macro_japan_unemployment_rate);
...
macro_test!(test_macro_australia_retail_rate_monthly, macro_australia_retail_rate_monthly);
macro_test!(test_macro_australia_trade, macro_australia_trade);
macro_test!(test_macro_australia_unemployment_rate, macro_australia_unemployment_rate);
macro_test!(test_macro_australia_ppi_quarterly, macro_australia_ppi_quarterly);
macro_test!(test_macro_australia_cpi_quarterly, macro_australia_cpi_quarterly);
...
macro_test!(test_australia_retail_rate_monthly, australia_retail_rate_monthly);
macro_test!(test_australia_trade, australia_trade);
macro_test!(test_australia_unemployment_rate, australia_unemployment_rate);
...
macro_test!(test_macro_canada_new_house_rate, macro_canada_new_house_rate);
macro_test!(test_macro_canada_unemployment_rate, macro_canada_unemployment_rate);
macro_test!(test_macro_canada_trade, macro_canada_trade);
macro_test!(test_macro_canada_retail_rate_monthly, macro_canada_retail_rate_monthly);
macro_test!(test_macro_canada_bank_rate, macro_canada_bank_rate);
macro_test!(test_macro_canada_core_cpi_yearly, macro_canada_core_cpi_yearly);
macro_test!(test_macro_canada_core_cpi_monthly, macro_canada_core_cpi_monthly);
...
macro_test!(test_macro_germany_trade_adjusted, macro_germany_trade_adjusted);
macro_test!(test_macro_germany_gdp, macro_germany_gdp);
macro_test!(test_macro_germany_retail_sale_monthly, macro_germany_retail_sale_monthly);
macro_test!(test_macro_germany_retail_sale_yearly, macro_germany_retail_sale_yearly);
...
macro_test!(test_germany_retail_sale_monthly, germany_retail_sale_monthly);
...
macro_test!(test_macro_china_hk_rate_of_unemployment, macro_china_hk_rate_of_unemployment);
macro_test!(test_macro_china_hk_gbp, macro_china_hk_gbp);
macro_test!(test_macro_china_hk_gbp_ratio, macro_china_hk_gbp_ratio);
macro_test!(test_macro_china_hk_building_volume, macro_china_hk_building_volume);
macro_test!(test_macro_china_hk_building_amount, macro_china_hk_building_amount);
macro_test!(test_macro_china_hk_trade_diff_ratio, macro_china_hk_trade_diff_ratio);
...
async fn test_rate_interbank() {
    ...
    mount_em_mocks(&server).await;
    let client = common::mock_client(&server);
    let result = client.rate_interbank(
        "上海银行同业拆借市场",
        "Shibor人民币",
        "隔夜",
    ).await;
...
macro_test!(test_macro_bank_usa_interest_rate, macro_bank_usa_interest_rate);
macro_test!(test_macro_bank_euro_interest_rate, macro_bank_euro_interest_rate);
macro_test!(test_macro_bank_newzealand_interest_rate, macro_bank_newzealand_interest_rate);
macro_test!(test_macro_bank_china_interest_rate, macro_bank_china_interest_rate);
macro_test!(test_macro_bank_switzerland_interest_rate, macro_bank_switzerland_interest_rate);
macro_test!(test_macro_bank_english_interest_rate, macro_bank_english_interest_rate);
macro_test!(test_macro_bank_australia_interest_rate, macro_bank_australia_interest_rate);
macro_test!(test_macro_bank_japan_interest_rate, macro_bank_japan_interest_rate);
macro_test!(test_macro_bank_russia_interest_rate, macro_bank_russia_interest_rate);
macro_test!(test_macro_bank_india_interest_rate, macro_bank_india_interest_rate);
macro_test!(test_macro_bank_brazil_interest_rate, macro_bank_brazil_interest_rate);
...
macro_test!(test_bank_newzealand_interest_rate, bank_newzealand_interest_rate);
macro_test!(test_bank_china_interest_rate, bank_china_interest_rate);
macro_test!(test_bank_switzerland_interest_rate, bank_switzerland_interest_rate);
macro_test!(test_bank_england_interest_rate, bank_england_interest_rate);
macro_test!(test_bank_australia_interest_rate, bank_australia_interest_rate);
