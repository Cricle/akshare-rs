...
- **rv_from_futures_zh_minute** — 从新浪期货分钟数据计算已实现波动率
- **rv_from_stock_zh_a_hist_min** — 从东方财富A股分钟数据计算已实现波动率
...
let rv = client.rv_from_stock_zh_a_hist_min("000001", "2024-01-01", "2024-01-31").await?;
```
