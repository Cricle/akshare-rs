...
### Daily Bars
- **futures_main** — Main contract daily data from Sina
- **futures_daily_bar** — Daily bar data from exchanges
- **futures_hist** — Historical futures data from Eastmoney

### Realtime Quotes
- **futures_zh_realtime** — Realtime quotes from Sina
- **futures_foreign_commodity_realtime** — Foreign commodity quotes

### Klines
- **futures_zh_minute** — Minute klines from Sina
- **futures_global_spot** — Global spot klines
- **futures_global_hist** — Global historical klines

### Inventory & Delivery
- **futures_inventory** — Inventory data from Eastmoney
...
let bars = client.futures_main("RB0").await?;

// Realtime quotes
let quotes = client.futures_zh_realtime(&["RB2410"]).await?;

// Inventory data
let inventory = client.futures_inventory().await?;
```
