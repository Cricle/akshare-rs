...
macro_test!(test_mock_index_global_name_table_yahoo, index_global_name_table_yahoo);
...
macro_test!(test_mock_index_inner_quote_sugar_msweet, index_inner_quote_sugar_msweet);
macro_test!(test_mock_index_news_sentiment_scope, index_news_sentiment_scope);
macro_test!(test_mock_index_outer_quote_sugar_msweet, index_outer_quote_sugar_msweet);
...
macro_test_arg1!(test_mock_index_detail_hist_adjust_cni, index_detail_hist_adjust_cni, "000001");
macro_test_arg1!(test_mock_index_eri, index_eri, "000001");
macro_test_arg1!(test_mock_index_global_hist_sina, index_global_hist_sina, ".INX");
...
macro_test_arg1!(test_mock_index_realtime_fund_sw, index_realtime_fund_sw, "801010");
...
macro_test_arg1!(test_mock_index_stock_cons_csindex, index_stock_cons_csindex, "000300");
macro_test_arg1!(test_mock_index_stock_cons_sina, index_stock_cons_sina, "000001");
macro_test_arg1!(test_mock_index_stock_cons_weight_csindex, index_stock_cons_weight_csindex, "000300");
macro_test_arg1!(test_mock_index_stock_zh_spot_em, index_stock_zh_spot_em, "上证系列指数");
...
macro_test_arg1!(test_mock_index_analysis_week_month_sw, index_analysis_week_month_sw, "801010");
macro_test_arg1!(test_mock_spot_goods, spot_goods, "铜");
macro_test_arg1!(test_mock_stock_zh_index_daily, stock_zh_index_daily, "000001");
...
macro_test_arg2!(test_mock_index_zh_a_hist, index_zh_a_hist, "000001", "daily");
macro_test_arg2!(test_mock_index_zh_a_hist_min, index_zh_a_hist_min, "000001", "5");
macro_test_arg2!(test_mock_index_global_candles, index_global_candles, ".INX", 100usize);
macro_test_arg2!(test_mock_sw_index_candles, sw_index_candles, "801010", 100usize);
macro_test_arg2!(test_mock_index_hist_sw, index_hist_sw, "801010", "day");
macro_test_arg3!(test_mock_index_analysis_daily_sw, index_analysis_daily_sw, "801010", "20240101", "20240131");
macro_test_arg2!(test_mock_index_analysis_weekly_sw, index_analysis_weekly_sw, "801010", "20240101");
macro_test_arg2!(test_mock_index_analysis_monthly_sw, index_analysis_monthly_sw, "801010", "20240101");
macro_test_arg2!(test_mock_index_hist_fund_sw, index_hist_fund_sw, "801010", "day");

// Three-arg index methods
macro_test_arg3!(test_mock_index_hk_daily, index_hk_daily, "HSI", "1000001", 100usize);
macro_test_arg3!(test_mock_index_global_hist_em, index_global_hist_em, "INX", ".INX", 100usize);
macro_test_arg3!(test_mock_index_hist_cni, index_hist_cni, "000001", "2024-01-01", "2024-12-31");
macro_test_arg3!(test_mock_index_detail_hist_cni, index_detail_hist_cni, "000001", "2024-01-01", "2024-12-31");

// Five-arg index methods
macro_test_arg5!(test_mock_index_zh_a_hist_min_em, index_zh_a_hist_min_em, "000001", "5", "2024-01-01", "2024-01-02", "qfq");
