...
async fn test_stock_board_concept_hist_em() {
    ...
    let result = client
        .stock_board_concept_hist("BK0715", "daily", "20240101", "20240103", "")
        .await;
    let _ = result;
}
...
async fn test_stock_board_concept_hist_em_name() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_concept_hist("绿色电力", "weekly", "20240101", "20240103", "qfq")
        .await;
    let _ = result;
}
...
async fn test_stock_board_concept_hist_min_em() {
    ...
    mount_catch_all_json(&server, board_kline_body()).await;
    let client = mock_client(&server);
    let result = client.stock_board_concept_hist_min("BK0715", "5").await;
    let _ = result;
}
...
async fn test_stock_board_concept_hist_min_em_1min() {
    ...
    let client = mock_client(&server);
    let result = client.stock_board_concept_hist_min("BK0715", "1").await;
    let _ = result;
}
...
async fn test_stock_board_concept_spot_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_board_concept_spot("BK0715").await;
    let _ = result;
}
...
async fn test_stock_board_industry_hist_em() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_industry_hist("BK1027", "daily", "20240101", "20240103", "")
        .await;
    let _ = result;
}
...
async fn test_stock_board_industry_spot_em() {
    ...
    mount_catch_all_json(&server, board_spot_body()).await;
    let client = mock_client(&server);
    let result = client.stock_board_industry_spot("BK1027").await;
    let _ = result;
}
...
async fn test_stock_board_change_em_industry() {
    ...
    .await;
    let client = mock_client(&server);
    let result = client.stock_board_change("行业板块").await;
    let _ = result;
}
...
async fn test_stock_board_change_em_concept() {
    ...
    .await;
    let client = mock_client(&server);
    let result = client.stock_board_change("概念板块").await;
    let _ = result;
}
...
async fn test_stock_board_concept_info_ths() {
    ...
    mount_catch_all_text(&server, &ths_concept_names_html()).await;
    let client = mock_client(&server);
    let result = client.stock_board_concept_info("阿里巴巴概念").await;
    let _ = result;
}
...
async fn test_stock_board_concept_index_ths() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_concept_index("阿里巴巴概念", "20240101", "20240103")
        .await;
    let _ = result;
}
...
async fn test_stock_board_concept_summary_ths() {
    ...
    let client = mock_client(&server);
    let result = client.stock_board_concept_summary("阿里巴巴概念").await;
    let _ = result;
}
...
async fn test_stock_board_industry_info_ths() {
    ...
    mount_catch_all_text(&server, &ths_industry_names_html()).await;
    let client = mock_client(&server);
    let result = client.stock_board_industry_info("小金属").await;
    let _ = result;
}
...
async fn test_stock_board_industry_index_ths() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_industry_index("小金属", "20240101", "20240103")
        .await;
    let _ = result;
}
...
async fn test_stock_board_industry_summary_ths() {
    ...
    mount_catch_all_text(&server, &ths_summary_html()).await;
    let client = mock_client(&server);
    let result = client.stock_board_industry_summary("小金属").await;
    let _ = result;
}
...
async fn test_stock_bid_ask_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_bid_ask("000001").await;
    let _ = result;
}
...
async fn test_stock_individual_info_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_individual_info("000001").await;
    let _ = result;
}
...
async fn test_stock_hk_security_profile_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_hk_security_profile("00593").await;
    let _ = result;
}
...
async fn test_stock_hk_company_profile_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_hk_company_profile("00593").await;
    let _ = result;
}
...
async fn test_stock_hot_search_baidu() {
    ...
    let client = mock_client(&server);
    let result = client.stock_hot_search("000001", "20240102").await;
    let _ = result;
}
...
async fn test_stock_hsgt_kamt_flow_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_hsgt_kamt_flow(30).await;
    let _ = result;
}
...
async fn test_stock_hsgt_north_net_flow_kamt_em() {
    ...
    mount_catch_all_json(&server, hsgt_flow_body()).await;
    let client = mock_client(&server);
    let result = client.stock_hsgt_north_net_flow_kamt(30).await;
    let _ = result;
}
...
async fn test_stock_hsgt_south_net_flow_kamt_em() {
    ...
    mount_catch_all_json(&server, hsgt_flow_body()).await;
    let client = mock_client(&server);
    let result = client.stock_hsgt_south_net_flow_kamt(30).await;
    let _ = result;
}
...
async fn test_stock_repurchase_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_repurchase(10).await;
    let _ = result;
}
...
async fn test_stock_gsrl_gsdt_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_gsrl_gsdt("20240115").await;
    let _ = result;
}
...
async fn test_stock_zh_growth_comparison_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_zh_growth_comparison("SZ000895").await;
    let _ = result;
}
...
async fn test_stock_zh_valuation_comparison_em() {
    ...
    mount_catch_all_json(&server, peer_comparison_body()).await;
    let client = mock_client(&server);
    let result = client.stock_zh_valuation_comparison("SZ000895").await;
    let _ = result;
}
...
async fn test_stock_hk_growth_comparison_em() {
    ...
    mount_catch_all_json(&server, peer_comparison_body()).await;
    let client = mock_client(&server);
    let result = client.stock_hk_growth_comparison("00700").await;
    let _ = result;
}
...
async fn test_stock_hk_valuation_comparison_em() {
    ...
    mount_catch_all_json(&server, peer_comparison_body()).await;
    let client = mock_client(&server);
    let result = client.stock_hk_valuation_comparison("00700").await;
    let _ = result;
}
...
async fn test_stock_hsgt_sh_hk_spot_em() {
    ...
    .await;
    let client = mock_client(&server);
    let result = client.stock_hsgt_sh_hk_spot(10).await;
    let _ = result;
}
...
async fn test_stock_hsgt_sz_hk_spot_em() {
    ...
    .await;
    let client = mock_client(&server);
    let result = client.stock_hsgt_sz_hk_spot(10).await;
    let _ = result;
}
...
async fn test_stock_financial_report_sina_balance() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_report("sh600600", "资产负债表")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_report_sina_cashflow() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_report("sh600600", "现金流量表")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_hk_report_em_balance() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_hk_report("00700", "资产负债表", "年度")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_hk_report_em_income() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_hk_report("00700", "利润表", "报告期")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_hk_report_em_cashflow() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_hk_report("00700", "现金流量表", "年度")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_hk_analysis_indicator_em() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_hk_analysis_indicator("00700", "年度")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_us_report_em_balance() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_us_report("TSLA", "资产负债表", "年报")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_us_report_em_income() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_us_report("TSLA", "综合损益表", "单季报")
        .await;
    let _ = result;
}
...
async fn test_stock_register_em_all() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_register("全部").await;
    let _ = result;
}
...
async fn test_stock_register_em_kcb() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_register("科创板").await;
    let _ = result;
}
...
async fn test_stock_register_em_cyb() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_register("创业板").await;
    let _ = result;
}
...
async fn test_stock_register_em_bse() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_register("北交所").await;
    let _ = result;
}
...
async fn test_stock_ipo_declare_em() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_ipo_declare().await;
    let _ = result;
}
...
async fn test_stock_ipo_review_em() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_ipo_review().await;
    let _ = result;
}
...
async fn test_stock_ipo_tutor_em() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_ipo_tutor().await;
    let _ = result;
}
...
async fn test_stock_zh_a_gbjg_em() {
    ...
    mount_catch_all_json(&server, em_securities_financial_body()).await;
    let client = mock_client(&server);
    let result = client.stock_zh_a_gbjg("603392.SH").await;
    let _ = result;
}
...
async fn test_stock_zygc_em() {
    ...
    let client = mock_client(&server);
    let result = client.stock_zygc("SH688041").await;
    let _ = result;
}
...
async fn test_stock_board_concept_hist_em_weekly() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_concept_hist("BK0715", "weekly", "20240101", "20240103", "qfq")
        .await;
    let _ = result;
}
...
async fn test_stock_board_concept_hist_em_monthly() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_concept_hist("BK0715", "monthly", "20240101", "20240103", "hfq")
        .await;
    let _ = result;
}
...
async fn test_stock_board_industry_hist_em_weekly() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_industry_hist("BK1027", "weekly", "20240101", "20240103", "qfq")
        .await;
    let _ = result;
}
...
async fn test_stock_board_concept_hist_min_em_30min() {
    ...
    mount_catch_all_json(&server, board_kline_body()).await;
    let client = mock_client(&server);
    let result = client.stock_board_concept_hist_min("BK0715", "30").await;
    let _ = result;
}
...
async fn test_stock_register_em_hzb() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_register("沪主板").await;
    let _ = result;
}
...
async fn test_stock_register_em_szb() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_register("深主板").await;
    let _ = result;
}
...
async fn test_stock_restricted_release_summary_em_sh_a() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_restricted_release_summary("沪市A股", "20240101", "20240131")
        .await;
    let _ = result;
}
...
async fn test_stock_restricted_release_summary_em_kcb() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_restricted_release_summary("科创板", "20240101", "20240131")
        .await;
    let _ = result;
}
...
async fn test_stock_restricted_release_summary_em_cyb() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_restricted_release_summary("创业板", "20240101", "20240131")
        .await;
    let _ = result;
}
...
async fn test_stock_restricted_release_summary_em_bse() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_restricted_release_summary("京市A股", "20240101", "20240131")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_us_analysis_indicator_em_quarterly() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_us_analysis_indicator("TSLA", "单季报")
        .await;
    let _ = result;
}
...
async fn test_stock_financial_us_analysis_indicator_em_cumulative() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_financial_us_analysis_indicator("TSLA", "累计季报")
        .await;
    let _ = result;
}
...
async fn test_stock_board_change_em_custom_fs() {
    ...
    let result = client.stock_board_change("m:90 t:3 f:!50").await;
    let _ = result;
}
...
async fn test_stock_board_concept_hist_em_invalid_period() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_concept_hist("BK0715", "invalid", "20240101", "20240103", "")
        .await;
    assert!(result.is_err());
}
...
async fn test_stock_board_concept_hist_em_invalid_adjust() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_board_concept_hist("BK0715", "daily", "20240101", "20240103", "invalid")
        .await;
    assert!(result.is_err());
}
...
async fn test_stock_zh_growth_comparison_em_short_symbol() {
    ...
    let result = client.stock_zh_growth_comparison("0001").await;
    assert!(result.is_err());
}
...
async fn test_stock_register_em_invalid_market() {
    ...
    mount_catch_all_json(&server, misc_datacenter_body()).await;
    let client = mock_client(&server);
    let result = client.stock_register("invalid_market").await;
    assert!(result.is_err());
}
...
async fn test_stock_restricted_release_summary_em_invalid_market() {
    ...
    let client = mock_client(&server);
    let result = client
        .stock_restricted_release_summary("invalid", "20240101", "20240131")
        .await;
    assert!(result.is_err());
}
