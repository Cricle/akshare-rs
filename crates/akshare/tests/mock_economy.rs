...
macro_test!(
    test_mock_amac_manager_cancelled_info,
    amac_manager_cancelled_info
);
macro_test!(
    test_mock_amac_manager_classify_info,
...
macro_test!(
    test_mock_amac_person_bond_org_list,
    amac_person_bond_org_list
);
macro_test!(
    test_mock_amac_person_fund_org_list,
...
macro_test!(
    test_mock_index_bloomberg_billionaires,
...
macro_test_arg1!(
    test_mock_index_bloomberg_billionaires_hist,
    index_bloomberg_billionaires_hist,
    "2024"
);
macro_test_arg1!(
    test_mock_movie_boxoffice_cinema_daily,
    movie_boxoffice_cinema_daily,
    "2024-01-01"
);
macro_test_arg1!(
    test_mock_movie_boxoffice_cinema_weekly,
    movie_boxoffice_cinema_weekly,
    "2024-01-01"
);
macro_test_arg1!(
    test_mock_movie_boxoffice_daily,
    movie_boxoffice_daily,
    "2024-01-01"
);
macro_test_arg1!(
    test_mock_movie_boxoffice_monthly,
    movie_boxoffice_monthly,
    "2024-01"
);
macro_test_arg1!(
    test_mock_movie_boxoffice_weekly,
    movie_boxoffice_weekly,
    "2024-01-01"
);
macro_test_arg1!(
    test_mock_movie_boxoffice_yearly,
    movie_boxoffice_yearly,
    "2024"
);
macro_test_arg1!(
    test_mock_movie_boxoffice_yearly_first_week,
...
async fn test_mock_air_quality_hist() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .air_quality_hist("北京", "2024-01-01", "2024-01-31")
        .await;
    let _ = result;
}
...
async fn test_mock_air_quality_watch_point() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .air_quality_watch_point("北京", "2024-01-01", "2024-01-31")
        .await;
    let _ = result;
}
macro_test_arg2!(test_mock_article_oman_rv, article_oman_rv, "AAPL", "1");
macro_test_arg2!(
    test_mock_car_market_cate_cpca,
    car_market_cate_cpca,
    "中国",
    "轿车"
);
macro_test_arg2!(
    test_mock_car_market_man_rank_cpca,
    car_market_man_rank_cpca,
    "中国",
    "1"
);
macro_test_arg2!(
    test_mock_car_market_segment_cpca,
    car_market_segment_cpca,
    "中国",
    "轿车"
);
macro_test_arg2!(
    test_mock_car_market_total_cpca,
    car_market_total_cpca,
    "中国",
    "1"
);
macro_test_arg2!(
    test_mock_car_sale_rank_gasgoo,
