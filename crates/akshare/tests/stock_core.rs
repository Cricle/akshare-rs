...
async fn test_stock_zh_a_hist_pre_min_em() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_zh_a_hist_pre_min_em("600000", "09:00", "09:30")
        .await;
}
...
async fn test_stock_us_famous_spot_em_tech() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_us_famous_spot_em("\u{79d1}\u{6280}\u{7c7b}")
        .await;
}
...
async fn test_stock_us_famous_spot_em_finance() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_us_famous_spot_em("\u{91d1}\u{878d}\u{7c7b}")
        .await;
}
...
async fn test_stock_us_famous_spot_em_pharma() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_us_famous_spot_em("\u{533b}\u{836f}\u{98df}\u{54c1}\u{7c7b}")
        .await;
}
...
async fn test_stock_us_famous_spot_em_media() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_us_famous_spot_em("\u{5a92}\u{4f53}\u{7c7b}")
        .await;
}
...
async fn test_stock_us_famous_spot_em_auto() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_us_famous_spot_em("\u{6c7d}\u{8f66}\u{80fd}\u{6e90}\u{7c7b}")
        .await;
}
...
async fn test_stock_us_famous_spot_em_retail() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_us_famous_spot_em("\u{5236}\u{9020}\u{96f6}\u{552e}\u{7c7b}")
        .await;
}
...
async fn test_stock_us_valuation_baidu_pb() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_us_valuation_baidu("MSFT", "\u{5e02}\u{51c0}\u{7387}", "\u{5168}\u{90e8}")
        .await;
}
...
async fn test_stock_zh_valuation_baidu_pcf() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_zh_valuation_baidu("600000", "\u{5e02}\u{73b0}\u{7387}", "\u{5168}\u{90e8}")
        .await;
}
...
async fn test_stock_zh_vote_baidu_stock() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_zh_vote_baidu("000001", "\u{80a1}\u{7968}")
        .await;
}
...
async fn test_stock_zh_vote_baidu_index() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_zh_vote_baidu("000001", "\u{6307}\u{6570}")
        .await;
}
...
async fn test_stock_zh_a_hist_pre_min_em_sz() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_zh_a_hist_pre_min_em("000001", "09:15", "09:25")
        .await;
}
...
async fn test_stock_hk_valuation_baidu_pb() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_hk_valuation_baidu("00593", "\u{5e02}\u{51c0}\u{7387}", "\u{5168}\u{90e8}")
        .await;
}
...
async fn test_stock_zh_valuation_baidu_all() {
    ...
    let client = mock_client(&server);
    let _ = client
        .stock_zh_valuation_baidu("600000", "\u{603b}\u{5e02}\u{503c}", "\u{5168}\u{90e8}")
        .await;
}
