...
macro_test!(
    test_mock_futures_fees_info_openctp,
...
macro_test!(
    test_mock_futures_contract_info_dce,
    futures_contract_info_dce
);
macro_test!(
    test_mock_futures_contract_info_gfex,
...
macro_test_arg1!(
    test_mock_futures_comex_inventory,
...
macro_test_arg1!(
    test_mock_futures_cffex_position_rank,
    futures_cffex_position_rank,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_contract_detail,
...
macro_test_arg1!(
    test_mock_futures_contract_detail_sina,
    futures_contract_detail_sina,
    "rb2401"
);
macro_test_arg1!(
    test_mock_futures_contract_info_cffex,
    futures_contract_info_cffex,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_contract_info_czce,
    futures_contract_info_czce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_contract_info_ine,
    futures_contract_info_ine,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_contract_info_shfe,
    futures_contract_info_shfe,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_czce_position_rank,
    futures_czce_position_rank,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_daily_cffex,
    futures_daily_cffex,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_daily_czce,
    futures_daily_czce,
    "2024-01-02"
);
macro_test_arg1!(test_mock_futures_daily_dce, futures_daily_dce, "2024-01-02");
macro_test_arg1!(
    test_mock_futures_daily_gfex,
    futures_daily_gfex,
    "2024-01-02"
);
macro_test_arg1!(test_mock_futures_daily_ine, futures_daily_ine, "2024-01-02");
macro_test_arg1!(
    test_mock_futures_daily_shfe,
    futures_daily_shfe,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_dce_position_rank,
    futures_dce_position_rank,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_delivery_czce,
    futures_delivery_czce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_delivery_dce,
    futures_delivery_dce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_delivery_match_czce,
    futures_delivery_match_czce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_delivery_match_dce,
    futures_delivery_match_dce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_delivery_shfe,
...
macro_test_arg1!(
    test_mock_futures_roll_yield_bar,
...
macro_test_arg1!(
    test_mock_futures_settle_cffex,
    futures_settle_cffex,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_settle_czce,
    futures_settle_czce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_settle_gfex,
    futures_settle_gfex,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_settle_ine,
    futures_settle_ine,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_settle_shfe,
    futures_settle_shfe,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_settlement_price_sgx,
    futures_settlement_price_sgx,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_shfe_position_rank,
    futures_shfe_position_rank,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_shfe_warehouse_receipt,
    futures_shfe_warehouse_receipt,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_spot_price,
    futures_spot_price,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_spot_price_previous,
    futures_spot_price_previous,
    "2024-01-02"
);
macro_test_arg1!(test_mock_futures_spot_prices, futures_spot_prices, 100usize);
macro_test_arg1!(
    test_mock_futures_spot_stock,
    futures_spot_stock,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_spot_stock_em,
    futures_spot_stock_em,
    "农产品"
);
macro_test_arg1!(test_mock_futures_stock_shfe_js, futures_stock_shfe_js, "rb");
macro_test_arg1!(
    test_mock_futures_to_spot_czce,
    futures_to_spot_czce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_to_spot_dce,
    futures_to_spot_dce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_to_spot_shfe,
    futures_to_spot_shfe,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_warehouse_receipt_czce,
    futures_warehouse_receipt_czce,
    "2024-01-02"
);
macro_test_arg1!(
    test_mock_futures_warehouse_receipt_dce,
...
macro_test_arg2!(
    test_mock_futures_settle,
    futures_settle,
    "2024-01-02",
    "cffex"
);
macro_test_arg2!(
    test_mock_futures_spot_price_daily,
...
macro_test_arg2!(
    test_mock_futures_zh_minute,
    futures_zh_minute,
    "rb2401",
    "5"
);
macro_test_arg2!(
    test_mock_futures_zh_spot,
    futures_zh_spot,
    "rb2401",
    "cffex"
);
macro_test_arg2!(
    test_mock_futures_dce_position_rank_other,
...
macro_test_arg3!(
    test_mock_futures_main_sina_derivative,
...
// ===== Additional futures test =====
#[tokio::test]
async fn test_mock_get_roll_yield_bar() {
    let server = wiremock::MockServer::start().await;
    mount_mocks(&server).await;
    let client = common::mock_client(&server);
