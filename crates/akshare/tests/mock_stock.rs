...
// 0/1/2-arg macros
macro_test_arg3!(
    test_mock_a_share_trade_calendar,
...
macro_test_arg3!(
    test_mock_stock_board_concept_index,
...
macro_test_arg3!(
    test_mock_stock_board_industry_index,
...
macro_test_arg1!(
    test_mock_stock_us_growth_comparison,
    stock_us_growth_comparison,
    "test"
);
macro_test_arg1!(
    test_mock_stock_us_valuation_comparison,
    stock_us_valuation_comparison,
    "test"
);
macro_test_arg1!(
    test_mock_stock_zh_a_financial_indicator,
    stock_zh_a_financial_indicator,
    "test"
);
macro_test_arg1!(
    test_mock_stock_zh_a_dividend_payout,
    stock_zh_a_dividend_payout,
    "test"
);
macro_test_arg1!(
    test_mock_stock_balance_sheet_by_report_em_typed,
    stock_balance_sheet_by_report_em_typed,
    "test"
);
macro_test_arg1!(
    test_mock_stock_cash_flow_sheet_by_report_em_typed,
    stock_cash_flow_sheet_by_report_em_typed,
    "test"
);
macro_test_arg3!(
    test_mock_stock_gdfx_holding_detail,
...
macro_test_arg1!(
    test_mock_stock_gpzy_individual_pledge_ratio_detail,
    stock_gpzy_individual_pledge_ratio_detail,
    "test"
);
macro_test_arg3!(
    test_mock_stock_hsgt_stock_statistics,
...
macro_test_arg3!(
    test_mock_stock_hsgt_institution_statistics,
...
macro_test_arg2!(
    test_mock_stock_hsgt_individual_detail,
    stock_hsgt_individual_detail,
    "test",
    "test"
);
macro_test_arg3!(
    test_mock_stock_lhb_stock_detail,
...
macro_test_arg2!(
    test_mock_stock_margin_account_info_em,
...
macro_test_arg2!(
    test_mock_stock_financial_analysis_indicator_em,
    stock_financial_analysis_indicator_em,
    "test",
    "test"
);
macro_test_arg3!(
    test_mock_stock_financial_hk_report,
...
macro_test_arg2!(
    test_mock_stock_financial_hk_analysis_indicator,
    stock_financial_hk_analysis_indicator,
    "test",
    "test"
);
macro_test_arg3!(
    test_mock_stock_financial_us_report,
...
macro_test_arg2!(
    test_mock_stock_financial_us_analysis_indicator,
    stock_financial_us_analysis_indicator,
    "test",
    "test"
);
macro_test_arg3!(
    test_mock_stock_restricted_release_summary,
...
macro_test_arg2!(
    test_mock_stock_restricted_release_detail,
    stock_restricted_release_detail,
    "test",
    "test"
);
macro_test_arg2!(
    test_mock_stock_restricted_release_stockholder,
    stock_restricted_release_stockholder,
    "test",
    "test"
);
macro_test_arg3!(
    test_mock_stock_history_dividend_detail,
...
macro_test_arg2!(
    test_mock_stock_financial_analysis_indicator,
    stock_financial_analysis_indicator,
    "test",
    "test"
);
macro_test_arg2!(
    test_mock_stock_financial_abstract_ths,
    stock_financial_abstract_ths,
    "test",
    "test"
);
macro_test_arg2!(
    test_mock_stock_financial_abstract_new,
    stock_financial_abstract_new,
    "test",
    "test"
);
macro_test_arg2!(
    test_mock_stock_financial_benefit_new,
    stock_financial_benefit_new,
    "test",
    "test"
);
macro_test_arg2!(
    test_mock_stock_hk_profit_forecast_et,
...
macro_test_arg1!(
    test_mock_stock_us_hot_rank_latest,
    stock_us_hot_rank_latest,
    "test"
);
macro_test_arg1!(
    test_mock_stock_us_hot_rank_detail,
    stock_us_hot_rank_detail,
    "test"
);
macro_test_arg1!(
    test_mock_stock_us_hot_rank_detail_realtime,
    stock_us_hot_rank_detail_realtime,
    "test"
);
macro_test_arg1!(
    test_mock_stock_us_financial_indicator,
    stock_us_financial_indicator,
    "test"
);
macro_test_arg1!(
    test_mock_stock_us_dividend_payout,
    stock_us_dividend_payout,
    "test"
);
macro_test_arg1!(
    test_mock_stock_us_scale_comparison,
    stock_us_scale_comparison,
    "test"
);
...
macro_test_arg3!(
    test_mock_stock_zh_a_cdr_daily,
...
macro_test_arg3!(
    test_mock_stock_zh_a_hist_pre_min,
...
macro_test_arg3!(
    test_mock_stock_zh_index_daily_em,
...
macro_test_arg3!(
    test_mock_stock_zh_index_daily_tx,
...
async fn test_mock_stock_board_concept_hist() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_board_concept_hist("test", "test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_board_industry_hist() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_board_industry_hist("test", "test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_zh_a_disclosure_report() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_zh_a_disclosure_report("test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_zh_a_hist_min() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_zh_a_hist_min("test", "test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_hk_hist() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_hk_hist("test", "test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_hk_hist_min() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_hk_hist_min("test", "test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_us_hist() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_us_hist("test", "test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_us_hist_min() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_us_hist_min("test", "test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_individual_notice_report() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_individual_notice_report("test", "test", Some("test"), Some("test"))
        .await;
    let _ = result;
}
...
async fn test_mock_stock_individual_basic_info_us_xq() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_individual_basic_info_us_xq("test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_individual_basic_info_hk_xq() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_individual_basic_info_hk_xq("test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_zh_a_daily() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_zh_a_daily("test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_zh_a_hist_tx() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_zh_a_hist_tx("test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_zh_b_daily() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_zh_b_daily("test", "test", "test", "test")
        .await;
    let _ = result;
}
...
async fn test_mock_stock_zh_kcb_daily() {
    ...
    let client = common::mock_client(&server);
    let result = client
        .stock_zh_kcb_daily("test", "test", "test", "test")
        .await;
    let _ = result;
}
