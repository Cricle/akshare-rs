...
macro_test!(
    test_mock_fund_financial_fund_daily,
...
macro_test!(
    test_mock_fund_report_asset_allocation,
...
macro_test_arg1!(
    test_mock_fund_etf_category_sina,
...
macro_test_arg1!(
    test_mock_fund_financial_fund_info,
    fund_financial_fund_info,
    "000001"
);
macro_test_arg1!(test_mock_fund_graded, fund_graded, 100usize);
macro_test_arg1!(
    test_mock_fund_graded_fund_info,
    fund_graded_fund_info,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_individual_analysis_xq,
    fund_individual_analysis_xq,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_individual_basic_info_xq,
    fund_individual_basic_info_xq,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_individual_achievement_xq,
    fund_individual_achievement_xq,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_individual_detail_info_xq,
    fund_individual_detail_info_xq,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_individual_profit_probability_xq,
...
macro_test_arg1!(
    test_mock_fund_money_fund_info,
...
macro_test_arg1!(
    test_mock_fund_portfolio_asset_allocation,
    fund_portfolio_asset_allocation,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_portfolio_bond_hold,
    fund_portfolio_bond_hold,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_portfolio_industry_allocation,
    fund_portfolio_industry_allocation,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_position_hist_lg,
...
macro_test_arg1!(
    test_mock_fund_report_half_year,
    fund_report_half_year,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_report_industry_allocation,
...
macro_test_arg1!(
    test_mock_fund_value_estimation,
    fund_value_estimation,
    "全部"
);
macro_test_arg1!(
    test_mock_fund_xueqiu_achievement,
    fund_xueqiu_achievement,
    "000001"
);
macro_test_arg1!(test_mock_fund_xueqiu_info, fund_xueqiu_info, "000001");
macro_test_arg1!(
    test_mock_fund_announcement_dividend,
    fund_announcement_dividend,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_announcement_report,
    fund_announcement_report,
    "000001"
);
macro_test_arg1!(
    test_mock_fund_announcement_personnel,
...
macro_test_arg2!(
    test_mock_fund_etf_category_ths,
    fund_etf_category_ths,
    "ETF",
    "2024-01-02"
);
macro_test_arg2!(
    test_mock_fund_hk_fund_hist,
    fund_hk_fund_hist,
    "000001",
    "分红送配详情"
);
macro_test_arg2!(
    test_mock_fund_individual_detail_hold_xq,
...
macro_test_arg2!(
    test_mock_fund_open_end_nav,
    fund_open_end_nav,
    "000001",
    100usize
);
macro_test_arg2!(
    test_mock_fund_open_fund_rank,
    fund_open_fund_rank,
    "000001",
    100usize
);
macro_test_arg2!(
    test_mock_fund_portfolio_change,
    fund_portfolio_change,
    "000001",
    "累计收益率走势"
);
macro_test_arg2!(
    test_mock_fund_portfolio_hold,
    fund_portfolio_hold,
    "000001",
    "2024-01-02"
);
