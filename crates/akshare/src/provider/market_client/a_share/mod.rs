...
use super::{
    ...
    wire::{
        ...
        EastmoneyDatacenterEnvelope, EastmoneyKlineEnvelope, EastmoneySearchEnvelope,
        EastmoneySectorConstituentEnvelope, EastmoneySectorRankingEnvelope,
    },
};
...
impl MarketDataClient {
    ...
    pub(super) async fn fetch_a_share_candles(
        &self,
        symbol: &str,
        adjust: &str,
        limit: usize,
...
impl MarketDataClient {
    ...
    pub(super) async fn fetch_a_share_capital_flow(
        &self,
        symbol: &str,
        limit: usize,
    ...
    pub(super) async fn fetch_a_share_sector_rankings_from_eastmoney(
        &self,
        sector_type: &str,
        limit: usize,
    ...
    pub(super) async fn fetch_a_share_sector_constituents_from_eastmoney(
        &self,
        sector_code: &str,
        limit: usize,
    ...
    pub(super) async fn fetch_a_share_sector_capital_flow_from_eastmoney(
        &self,
        sector_code: &str,
        limit: usize,
    ) -> anyhow::Result<Vec<CapitalFlowPoint>> {
    ...
    pub(super) async fn fetch_a_share_announcement_detail(
        &self,
        art_code: &str,
    ...
    pub(super) async fn fetch_a_share_announcements(
        &self,
        ts_code: &str,
        limit: usize,
...
impl MarketDataClient {
    pub(super) async fn fetch_a_share_billboard_entries(
        &self,
        symbol: &str,
        limit: usize,
    ...
    pub(super) async fn fetch_a_share_billboard_seats(
        &self,
        symbol: &str,
        side: &str,
        limit: usize,
